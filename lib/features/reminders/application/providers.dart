...
final activeRemindersProvider = StreamProvider.autoDispose<List<Reminder>>((
  ref,
) {
...
final chainRemindersProvider = StreamProvider.autoDispose
    .family<List<Reminder>, int>((ref, chainId) {
